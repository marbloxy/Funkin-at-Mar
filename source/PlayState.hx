...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		...
		['mar type beat xdxdxdxdxdxdxdxxdxdxdxdxdxdxdxdxdxd i love this easter egg', 0.9], //From 80% to 89%
	...
	function marIntro()
	{
		...
		{
			case 'slowed-down':
				cutsceneHandler.endTime = 14;
				cutsceneHandler.music = 'dialoguemusic_quitet';
				precacheList.set('Song2', 'sound');
				precacheList.set('undertalestory', 'sound');
				precacheList.set('vomit', 'sound');

				var Song2:FlxSound = new FlxSound().loadEmbedded(Paths.sound('CutsceneS/Song2'));
				FlxG.sound.list.add(Song2);
				var undertalestory:FlxSound = new FlxSound().loadEmbedded(Paths.sound('CutsceneS/undertalestory'));
				FlxG.sound.list.add(undertalestory);
				var vomit:FlxSound = new FlxSound().loadEmbedded(Paths.sound('CutsceneS/vomit'));
				FlxG.sound.list.add(vomit);

				cutsceneHandler.timer(0.5, function()
				{
					var bfSay:FlxText = new FlxText(12, FlxG.height - 24, 0, "That was short.");
					bfSay.scrollFactor.set();
					bfSay.setFormat("VCR OSD Mono", 40, FlxColor.CYAN, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
					bfSay.screenCenter(X);
					add(bfSay);
					...
					camFollow.y += 100;
						cutsceneHandler.timer(2.3, function()
						{
							bfSay.text = ' ';
											...
											cutsceneHandler.timer(8.0, function()
										{
						bfSay.text = 'uhh nother song??';
						FlxG.sound.play(Paths.sound('vomit'));
						bfSay.screenCenter(X);
					});

																cutsceneHandler.timer(9.0, function()
										{
															camFollow.x += 750;
					camFollow.y += 100;
						bfSay.text = ' ';
				...
				cutsceneHandler.timer(1.2, function()
				{
					boyfriend.playAnim('singLEFT', true);
					boyfriend.specialAnim = true;
					FlxG.sound.play(Paths.sound('undertalestory'));
				});
				...
				cutsceneHandler.timer(1.9, function()
				{
					boyfriend.playAnim('singUP', true);
					boyfriend.specialAnim = true;
				});
				...
				cutsceneHandler.timer(2.3, function()
				{
					var marSay:FlxText = new FlxText(12, FlxG.height - 24, 0, "Yeah who cares, my computer just exploded from clicking an ad.");
					marSay.scrollFactor.set();
					marSay.setFormat("VCR OSD Mono", 40, FlxColor.PURPLE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
					marSay.screenCenter(X);
					add(marSay);
					FlxG.sound.play(Paths.sound('Song2'));
					...
					{
						marSay.text = 'think i wanna do dis??';
						marSay.screenCenter(X);
					});
					cutsceneHandler.timer(8.0, function()
										{
				...
				cutsceneHandler.timer(2.9, function()
				{
					dad.playAnim('singDOWN', true);
				});

				cutsceneHandler.timer(3.4, function()
				{
					dad.playAnim('singRIGHT', true);
				});

				cutsceneHandler.timer(4.1, function()
				{
				...
				cutsceneHandler.timer(4.9, function()
				{
					dad.playAnim('singDOWN', true);
				});

				cutsceneHandler.timer(5.3, function()
				{
					dad.playAnim('singUP', true);
				});

				cutsceneHandler.timer(5.7, function()
				{
					dad.playAnim('singLEFT', true);
				});
				...
				cutsceneHandler.timer(6.2, function()
				{
					dad.playAnim('singUP', true);
					});
				...
				cutsceneHandler.timer(9.5, function()
				{
					dad.playAnim('singLEFT', true);
				});

				cutsceneHandler.timer(9.7, function()
				{
					dad.playAnim('singLEFT', true);
				});

				cutsceneHandler.timer(11.0, function()
				{
				...
				cutsceneHandler.timer(14.0, function()
				{
				moveCamera(true);
				startCountdown();

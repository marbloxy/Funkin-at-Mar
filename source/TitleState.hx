...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		logoBl.animation.addByPrefix('bump', 'Bopping', 24, false);
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 2:
					#if PSYCH_WATERMARKS
					createCoolText(['Funkin at Mar by'], 15);
					#else
				...
				case 4:
					#if PSYCH_WATERMARKS
					addMoreText('Mar', 15);
					addMoreText('Gnk02', 15);
					addMoreText('R4ul_Isa123', 15);
					addMoreText('ForgettablePyromaniac', 15);
					addMoreText('ColdFoundX', 15);
					#else
					addMoreText('present');
					#end
				// credTextShit.text += '\npresent...';
				...
				// credTextShit.text += '\nNight';
				case 16:
					addMoreText('Mar'); // credTextShit.text += '\nFunkin';
